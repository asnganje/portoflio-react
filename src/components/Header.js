...
const Header = () => {
    ...
    return(
        <header className="flex justify-between bg-gradient-to-r from-gray-500 to-black p-4 mx-3">
            <h3 className="text-xl font-bold font-mono tracking-tighter text-white cursor-pointer mb:4 md: mb:0 animate-rotate">{identify}</h3>
            {isSmallScreen?
                (
                    <>
